...
- **Call data arrives by signed webhook** from a third-party call-analysis product. We consume it;
  we do not transcribe. The payload contract is in the PRD.
...
2. **Call-analysis vendor.** Shown as "VoiceIQ", a placeholder for whichever product Sanmar adopts.
   *(PRD open question #1)*
