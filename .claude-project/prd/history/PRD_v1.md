...
| Unit sizes | 1,150 / 1,450 / 1,650 / 2,100 sqft; 2–4 bedrooms |
| Project names | Sanmar Ocean City *(their real HQ development)* plus illustrative siblings — Sanmar Ruby Twin, Sanmar Springdale, Sanmar Green Court. **These must be replaced with Sanmar's actual project list before the client meeting** |
| Campaigns | "FB Lead Gen — Khulshi 3BR Sep", "Google Search — Apartment Chittagong", "Property Fair CTG Aug", "Billboard GEC Circle", "Referral — Existing Owners" |
...
|:-:|----------|-----------------|-------|--------|
| 1 | Which call-intelligence product does Sanmar use or intend to buy? | Determines the real webhook contract, whether Bangla transcription quality is adequate, and whether intent scoring is provided or must be derived. The prototype assumes a generic signed webhook | Client | ⏳ Open |
| 2 | What are Sanmar's actual live projects, unit types and price bands? | Business-fit scoring is 45% of the composite and depends entirely on real inventory. Prototype uses illustrative names | Client | ⏳ Open |
