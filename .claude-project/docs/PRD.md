...
|---------|---------|-----------|
| **Riseup Labs conversational-AI and voice platform** (in production) | Call recording, transcription, summary, engagement and intent signals | **Inbound** webhook to us |
...
|:-:|----------|-----------------|-------|--------|
| 1 | ~~Which call-intelligence product does Sanmar use or intend to buy?~~ **Resolved — our own platform** | Determines the real webhook contract, whether Bangla transcription quality is adequate, and whether intent scoring is provided or must be derived. The prototype assumes a generic signed webhook and the provider is **Riseup Labs' own conversational-AI and voice platform**, already in production. The contract is therefore ours to define rather than a third party's to dictate | Riseup | ✅ Resolved |
